...
function getLevel(score) {
  if (score >= 250) return {name:'傳說', color:'#fbbf24', bg:'rgba(251,191,36,0.2)'};
  if (score >= 200) return {name:'大師', color:'#a855f7', bg:'rgba(168,85,247,0.2)'};
  if (score >= 150) return {name:'高手', color:'#3b82f6', bg:'rgba(59,130,246,0.2)'};
  if (score >= 100) return {name:'進階', color:'#f97316', bg:'rgba(249,115,22,0.2)'};
  if (score >= 50)  return {name:'學徒', color:'#22c55e', bg:'rgba(34,197,94,0.2)'};
  return {name:'新手', color:'#94a3b8', bg:'rgba(148,163,184,0.2)'};
}
