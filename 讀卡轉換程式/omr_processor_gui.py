...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Label(self, text='📊 OMR 讀卡結果處理工具',
                 font=('Arial', 14, 'bold'), fg='#2F5496').pack(**PAD, pady=(14, 4))
        ...
        frm_in.pack(fill='x', **PAD, pady=(10, 2))
        ...
        frm_out.pack(fill='x', **PAD, pady=2)
        ...
        frm_opt.pack(fill='x', **PAD, pady=(6, 2))
        ...
        self.txt_log.pack(**PAD, pady=(6, 14))
